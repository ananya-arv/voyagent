...
export const BOOKING_URL_RULES = `Construct a deep-linked booking_url for each event using these rules. URL-encode the destination/city where it appears.
...
{num_travelers} is the traveler count. If you cannot build a meaningful URL, use null.`;
